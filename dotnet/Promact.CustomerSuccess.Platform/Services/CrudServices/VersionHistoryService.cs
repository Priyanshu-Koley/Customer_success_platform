...
namespace Promact.CustomerSuccess.Platform.Services
{
        ...
        >, IVersionHistoryService
    {
        ...
        public VersionHistoryService(IRepository<VersionHistory, Guid> versionHistoryRepository, IAsyncQueryableExecuter asyncExecuter) : base(versionHistoryRepository)
        {
